...
This is an official addon to [PridePack](https://modrinth.com/project/pridepack) that changes the Minecraft GUI to have a light theme, with LGBT details.
It is available for many versions, starting from beta 1.7.3. You can get [PrideGUI: Light Mode Legacy here](https://modrinth.com/project/pridegui-legacy-light), which has versions of the back for all versions between b1.7.3 and 1.20.1.

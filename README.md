...
This, is PrideGUI. An official addon to [PridePack](https://github.com/Pridecraft-Studios/pridepack) that changes the Minecraft GUI to be LGBT Themed

Currently this is in an *test development phase*, as such, it cannot be downloaded yet until all the first release is ready.
